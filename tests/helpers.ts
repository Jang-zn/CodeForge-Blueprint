...
import { SCHEMA_SQL, MIGRATION_V2_SQL, MIGRATION_V39_SQL, MIGRATION_V42_SQL, MIGRATION_V43_SQL, MIGRATION_V44_SQL, MIGRATION_V45_SQL, seedPerspectives } from '../src/db/schema.js';
...
export function createTestDb(): any {
  ...
  try { db.exec(MIGRATION_V44_SQL); } catch { /* ignore */ }
  try { db.exec(MIGRATION_V45_SQL); } catch { /* ignore */ }
  seedPerspectives(db);
  return db;
}
