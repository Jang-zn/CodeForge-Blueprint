...
- 각 섹션을 충분한 깊이로 서술하세요. 간략한 한 줄 요약은 금지합니다. 스캔 결과에서 관찰한 구체적인 증거를 들어 서술하세요.
- 제공된 스캔 결과에 없는 정보는 절대 만들어내지 마세요. 추측하지 말고 [TBD]로 표시하세요.
- 파일 접근, 권한 요청, 도구 사용 등의 메타 코멘트를 출력하지 마세요. 문서 내용만 출력하세요.
